    ...
    return (
        <CardLayout>
            <div className="card_stylings transition px-8 py-10">
                ...
                {data.positionLink && (
                    <a 
                        href={data.positionLink.url}
                        target="_blank"
                        rel="noreferrer"
                        className="inline-block mt-4 text-sm text-Green hover:text-Snow transition-colors duration-300 font-medium"
                    >
                        {data.positionLink.text}
                    </a>
                )}
            </div>
        </CardLayout>
