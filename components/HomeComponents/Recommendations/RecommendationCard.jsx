        ...
        <CardLayout>
            <div className="p-8 h-full relative card_stylings transition">
                <a href={data?.linkednURL} target="_blank" rel="noreferrer">
                    <img src={data?.image} className="absolute z-10 right-10 -top-5 border-Green w-16 h-16 border-[3px] rounded-full m-0 cursor-pointer hover:opacity-80 transition-opacity" />
                </a>
